  ...
  <div className="container py-5">
    <div className="row h-100 align-items-center py-5">
      <div className="col-lg-6">
        <h3 className="display-4">About AMIGOS GANG</h3>
  ...
  <div className="container py-5">
    <div className="row align-items-center mb-5">
      ...
      <div className="col-lg-5 px-5 mx-auto order-1 order-lg-2">
        <img src="https://bootstrapious.com/i/snippets/sn-about/img-1.jpg" className="img-fluid mb-4 mb-lg-0"/>
        </div>
    </div>
    <div className="row align-items-center">
      <div className="col-lg-5 px-5 mx-auto">
        <img src="https://bootstrapious.com/i/snippets/sn-about/img-2.jpg" className="img-fluid mb-4 mb-lg-0"/>
        </div>
    ...
    <div className="row text-center">
      <div className="col-xl-3 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4">
            <img src="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
      ...
      <div className="col-xl-3 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4">
            <img src="https://bootstrapious.com/i/snippets/sn-about/avatar-3.png" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
      ...
      <div className="col-xl-3 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4">
            <img src="https://bootstrapious.com/i/snippets/sn-about/avatar-2.png" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
      ...
      <div className="col-xl-3 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4">
            <img src="https://bootstrapious.com/i/snippets/sn-about/avatar-1.png" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
